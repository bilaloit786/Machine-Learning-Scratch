...
This repository contains a Jupyter Notebook demonstrating a basic implementation of the K-Means clustering algorithm on 5 two-dimensional data points using K=2 clusters.
